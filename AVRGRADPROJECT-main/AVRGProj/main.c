...
uint8_t Read_Gesture(void)
{
    ...
    difference =
        (current > CALIBRATION_u16GetBaseline(0)) ?
        (current - CALIBRATION_u16GetBaseline(0)) :
        (CALIBRATION_u16GetBaseline(0) - current);
    ...
    difference =
        (current > CALIBRATION_u16GetBaseline(1)) ?
        (current - CALIBRATION_u16GetBaseline(1)) :
        (CALIBRATION_u16GetBaseline(1) - current);
    ...
    difference =
        (current > CALIBRATION_u16GetBaseline(2)) ?
        (current - CALIBRATION_u16GetBaseline(2)) :
        (CALIBRATION_u16GetBaseline(2) - current);
    ...
    difference =
        (current > CALIBRATION_u16GetBaseline(3)) ?
        (current - CALIBRATION_u16GetBaseline(3)) :
        (CALIBRATION_u16GetBaseline(3) - current);
    ...
    difference =
        (current > CALIBRATION_u16GetBaseline(4)) ?
        (current - CALIBRATION_u16GetBaseline(4)) :
        (CALIBRATION_u16GetBaseline(4) - current);
...
int main(void)
{
    ...
    /* Load saved user calibration, or calibrate on first run. */
